###biasedCorrelatedEx.R

#Written by Nathan Hasegawa

#Generates synthetic data where the predictors and responses are biased,
#but there are a lot more predictors than responses.
...
folderpath <- "Desktop/NSH_WI26_Rotation/biasedCorrelatedExImages"

#Import the training data
train <- read.csv("Desktop/NSH_WI26_Rotation/SyntheticData/biasedCorrelatedExTrain.csv")
y <- train[,1]
x <- train[,-1]
...
#Import test data
test <- read.csv("Desktop/NSH_WI26_Rotation/SyntheticData/biasedCorrelatedExTest.csv")
y.test <- test[,1]
x.test <- test[,-1]
...
save(model.standard, model.mgaussian, test, train, alpha, resid.test.std,
     ...
     file="Desktop/NSH_WI26_Rotation/Workspaces/biasedCorrelatedEx.RData")

#CAN START HERE

load("Desktop/NSH_WI26_Rotation/Workspaces/biasedCorrelatedEx.RData")
folderpath <- "Desktop/NSH_WI26_Rotation/biasedCorrelatedExImages"
