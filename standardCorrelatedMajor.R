...
folderpath <- "Desktop/NSH_WI26_Rotation/standardCorrelatedMajorImages"

#Import the training data
train <- read.csv("Desktop/NSH_WI26_Rotation/SyntheticData/standardCorrelatedMajorTrain.csv")
y <- train[,1]
x <- train[,-1]
...
#Import test data
test <- read.csv("Desktop/NSH_WI26_Rotation/SyntheticData/standardCorrelatedMajorTest.csv")
y.test <- test[,1]
x.test <- test[,-1]
...
save(model.standard, model.mgaussian, test, train, alpha, resid.test.std,
     ...
     file="Desktop/NSH_WI26_Rotation/Workspaces/standardCorrelatedMajor.RData")

#CAN START HERE

load("Desktop/NSH_WI26_Rotation/Workspaces/standardCorrelatedMajor.RData")
folderpath <- "Desktop/NSH_WI26_Rotation/standardCorrelatedMajorImages"
...
mga.a1.plot <- mga.a1.plot[mga.a1.plot$nonzero < 15,]
