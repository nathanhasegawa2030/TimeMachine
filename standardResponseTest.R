...
#The plot below shows the distribution of training responses. It is roughly
#uniform.
...
x1.t <- x.test[,1]
x2.t <- x.test[,2]
y.test <- atan2(1.4*cos(x1.t) - 1.1*cos(x2.t) + 0.8*sin(x1.t) + 0.9*sin(x2.t),
                1.1*cos(x1.t) - 0.9*cos(x2.t) - 1.2*sin(x1.t) - 0.6*sin(x2.t)) + 
