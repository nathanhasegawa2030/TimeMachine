...
#Model is trying to estimate sin and not cos, since that's what's controlling
#the response. CV r^2 for cos is near 0
sin.top <- sin.agg[sin.agg$r2 > 0.63,]
mga.top <- mga.agg[mga.agg$r2 > 0.45,]
