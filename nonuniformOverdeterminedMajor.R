...
###NOTE: WE USE 5000 ROWS, NOT 100, IN THE TEST DATA. THIS GIVES US MORE ACCURATE
###TEST RESULTS AND HAS NO EFFECT ON THE PREDICTIVE MODEL BECAUSE THE TEST DATA IS
###INDEPENDENT.
test <- read.csv("Desktop/NSH_WI26_Rotation/SyntheticData/TestBiased.csv")
y.test <- test[,1]
x.test <- test[,-1]
...
###TODO: SHOW HISTOGRAM OF RESIDUALS FOR BEST MODELS
###ALSO THINK ABOUT SHOWING HISTOGRAMS FOR RESIDUALS WITH BEST TRAINING CV R2—
###IN PRACTICE, THAT IS SOMETIMES WHAT YOU WOULD USE (BUT WITH TIMEMACHINE,
###WE DO RESERVE SOME DATA FOR TESTING)
...
###TODO: SHOW HISTOGRAM OF TEST PREDICTORS AND RESPONSES. WORK ON THIS MORE
