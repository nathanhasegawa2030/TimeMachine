...
folderpath <- "Desktop/NSH_WI26_Rotation/standardCorrelatedMinorImages"

#Import the training data
train <- read.csv("Desktop/NSH_WI26_Rotation/SyntheticData/standardCorrelatedMinorTrain.csv")
y <- train[,1]
x <- train[,-1]
...
#Import test data
test <- read.csv("Desktop/NSH_WI26_Rotation/SyntheticData/standardCorrelatedMinorTest.csv")
y.test <- test[,1]
x.test <- test[,-1]
...
save(model.standard, model.mgaussian, test, train, alpha, resid.test.std,
     ...
     file="Desktop/NSH_WI26_Rotation/Workspaces/standardCorrelatedMinor.RData")

#CAN START HERE

load("Desktop/NSH_WI26_Rotation/Workspaces/standardCorrelatedMinor.RData")
folderpath <- "Desktop/NSH_WI26_Rotation/standardCorrelatedMinorImages"
